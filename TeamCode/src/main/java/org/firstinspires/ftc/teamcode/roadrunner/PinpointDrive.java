...
//        return pinpoint.getVelocity();
        return new PoseVelocity2d(new Vector2d(getPinpoint().getVelX(), pinpoint.getVelY()), getPinpoint().getHeadingVelocity());
    }
    ...
    public static class Params {
        ...
        public double xOffset = -156;
        public double yOffset = 112;
