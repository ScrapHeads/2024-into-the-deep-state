...
public class GoBildaPinpointDriver extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public Pose2d setPosition2d(Pose2d pos) {
        writeByteArray(Register.Y_POSITION, (floatToByteArray((float) getPosX(), ByteOrder.LITTLE_ENDIAN)));
        writeByteArray(Register.Y_POSITION, (floatToByteArray((float) getPosY(), ByteOrder.LITTLE_ENDIAN)));
        writeByteArray(Register.H_ORIENTATION, (floatToByteArray((float) getHeading(), ByteOrder.LITTLE_ENDIAN)));
        return pos;
    }
    ...
    public Pose2d setPosition2d() {
        return new Pose2d(
                new Vector2d(xPosition, yPosition),
                hOrientation);
    }
