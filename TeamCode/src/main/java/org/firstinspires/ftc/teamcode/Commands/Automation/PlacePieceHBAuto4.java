...
public class PlacePieceHBAuto4 extends SequentialCommandGroup {
    public PlacePieceHBAuto4(ArmLiftIntake lift, ArmRotateIntake rotation, Claw claw, ClawWristVert wClawV) {
        addCommands(
