...
public class RotateClawHorizontal extends CommandBase {
    //linking claw variable to the Claw subsystem
    private final ClawRotateHorizontal claw;
    //Creating the position to set the servo to
    private final double pos;

    public RotateClawHorizontal(ClawRotateHorizontal claw, double pos) {
